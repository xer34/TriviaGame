...
var questions = [
  ...
  {
    question:
      "In the movie, Avengers: Infinity War, what does Spider-Man say to Tony Stark at the end?",
  ...
  {
    question:
      "What is the other primary language spoken in the show 'Firefly'?",
    optionA: "A. Mandarin",
    optionB: "B. Japanese",
    optionC: "C. German",
    optionD: "D. Binary",
  ...
  var timer = duration,
    ...
    interval = setInterval(function() {
      ...
      if (timer < 0) {
        ...
        if (!selectedOption) {
          $("#result").text(
            "You did not select an answer! Reloading question in 5 seconds!"
          );
          wrongAudio.play();
          $("#result").show();
          $(".notSelected").show();
        ...
        if (questions[currentQuestion].answer === answer) {
          ...
          $("#result").text(
            "You are wrong-a-long-a-ding-dong! The correct answer was " +
              answer +
...
$("#playButton").on("click", loadQuestion(currentQuestion));
